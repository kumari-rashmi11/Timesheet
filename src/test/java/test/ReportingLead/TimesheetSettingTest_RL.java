...
public class TimesheetSettingTest_RL extends BaseTest {
	...
	public void initialTest() {
		...
		interact.executeWithDelay(() -> ts.clickTimesheetSetting_RL());
	}

	@Test(priority = 2, retryAnalyzer = RetryAnalyzer.class)
	public void Add_new_timesheet_setting_TC_046_RL() {
		Interactions interact = new Interactions(driver);
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		initialTest();
	...
	public void Modify_timesheet_setting_TC_047_RL() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
		initialTest();
	...
	public void Delete_timesheet_setting_TC_048_RL() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
		initialTest();
	...
	public void Search_using_employee_TC_049_RL() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
		initialTest();
	...
	public void Search_using_client_TC_050_RL() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
		initialTest();
	...
	public void Search_and_refresh_TC_051_RL() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
	...
	public void Active_employee_visibility_TC_277_RL() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
		initialTest();
		interact.executeWithDelay(() -> ts.addEmployees());

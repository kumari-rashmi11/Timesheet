...
public class TasksAllocationTest_Editor extends BaseTest {
	public void initialTestFor_Editor() {
		...
		interact.executeWithDelay(() -> tasks.clickTasksAllocationTab_Editor());
		Assert.assertEquals(tasks.isTasksAllocationPage(), "Tasks");
	}
	
	@Test(priority = 2, retryAnalyzer = RetryAnalyzer.class)
	public void Remaining_hours_alert_icon_TC_295_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.alertIconHover_Editor());
	}
	
	@Test(priority = 3, retryAnalyzer = RetryAnalyzer.class)
	public void Create_New_Task_TC_041_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
...
//		interact.executeWithDelay(() -> tasks.clickCreateBtn());
	...
	public void Edit_Task_TC_042_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
	...
	public void Delete_Task_TC_043_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.clickSelectTask());
...
//		interact.executeWithDelay(() -> tasks.clickDeleteConfirm());
	...
	public void Search_Operation_TC_044_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
	...
	public void Search_and_Reset_Operation_TC_045_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.searchEmployee());
	...
	public void Only_Active_Employee_Visibility_for_Reallocation_Task_TC_282_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_Editor());
		interact.executeWithDelay(() -> tasks.clickAssignBtn());
		interact.executeWithDelay(()-> tasks.clickAssignEmployeeDiv());
	}
	
	@Test(priority = 9, retryAnalyzer = RetryAnalyzer.class)
	public void Task_Reallocation_Operation_TC_132_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_Editor());
...
//		interact.executeWithDelay(()-> tasks.clickReallocateTask());
	...
	public void Modification_of_Reallocated_Task_TC_133_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_Editor());
...
//		interact.executeWithDelay(()-> tasks.clickReallocateTask());
	...
	public void Delete_operation_of_reallocation_task_TC_134_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_Editor());
	...
	public void Cannot_Allocate_hours_above_consumed_TC_164_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_Editor());
	...
	public void Only_Active_Employee_Visibility_for_Task_Allocation_TC_278_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(()-> tasks.clickCreateTaskBtn());
	...
	public void Saving_Reallocated_Task_after_Edit_TC_135_Editor() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_Editor();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_Editor());

...
public class TimesheetSettingTest_Editor extends BaseTest {
	public void initialTest() {
        ...
        interact.executeWithDelay(() -> ts.clickTimesheetSetting_Editor());
	}
	
	
    @Test(priority = 2, retryAnalyzer = RetryAnalyzer.class)
    public void Add_new_timesheet_setting_TC_046_Editor() {
    	Interactions interact = new Interactions(driver);
    	TimesheetSettingPage ts = new TimesheetSettingPage(driver);
    	initialTest();
    ...
    public void Modify_timesheet_setting_TC_047_Editor() {
    	TimesheetSettingPage ts = new TimesheetSettingPage(driver);
        Interactions interact = new Interactions(driver);
        initialTest();
    ...
    public void Delete_timesheet_setting_TC_048_Editor() {
    	TimesheetSettingPage ts = new TimesheetSettingPage(driver);
        Interactions interact = new Interactions(driver);
        initialTest();
    ...
    public void Search_using_employee_TC_049_Editor() {
    	TimesheetSettingPage ts = new TimesheetSettingPage(driver);
        Interactions interact = new Interactions(driver);
        initialTest();
    ...
    public void Search_using_client_TC_050_Editor() {
    	TimesheetSettingPage ts = new TimesheetSettingPage(driver);
        Interactions interact = new Interactions(driver);
        initialTest();
    ...
    public void Search_and_refresh_TC_051_Editor() {
    	TimesheetSettingPage ts = new TimesheetSettingPage(driver);
        Interactions interact = new Interactions(driver);
    ...
    public void Active_employee_visibility_TC_277_Editor() {
    	TimesheetSettingPage ts = new TimesheetSettingPage(driver);
        Interactions interact = new Interactions(driver);
        initialTest();
        interact.executeWithDelay(() -> ts.addEmployees());

...
public class TimesheetSettingTest_Viewer extends BaseTest {
	...
	public void Search_using_employee_TC_049_Viewer() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
		initialTest();
	...
	public void Search_using_client_TC_050_Viewer() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);
		initialTest();
	...
	public void Search_and_refresh_TC_051_Viewer() {
		TimesheetSettingPage ts = new TimesheetSettingPage(driver);
		Interactions interact = new Interactions(driver);

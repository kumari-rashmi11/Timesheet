...
public class EmployeesTest_Viewer extends BaseTest {
	...
	public void initialTest() {
		...
		interact.executeWithDelay(() -> ep.clickEmployeesTab_Viewer());
	}

	@Test(priority = 1, retryAnalyzer = RetryAnalyzer.class)
	public void details_of_employees_Viewer_TC017() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
	...
	public void search_Operation_Viewer_TC019() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
	...
	public void refresh_Operation_Viewer_TC020() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
		interact.executeWithDelay(() -> ep.searchOperation());
	...
	public void active_Employees_only_in_active_tab_Viewer_TC255() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
	...
	public void inactive_Employees_only_in_inactive_tab_Viewer_TC256() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
	...
	public void relieved_Employees_only_in_relieved_tab_Viewer_TC257() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
	...
	public void components_of_past_and_persent_lead_info_screen_Viewer_TC296() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
		interact.executeWithDelay(() -> ep.employeeDetails());
	...
	public void visibility_of_past_and_persent_lead_info_screen_Viewer_TC297() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
		interact.executeWithDelay(() -> ep.employeeDetails());
	...
	public void closing_past_and_persent_lead_info_screen_Viewer_TC298() {
		initialTest();
		EmployeesPage ep = new EmployeesPage(driver);
		Interactions interact = new Interactions(driver);
		interact.executeWithDelay(() -> ep.employeeDetails());

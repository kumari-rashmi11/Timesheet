...
public class ChargeActivityTypeTest_PL extends BaseTest {
	public void initialTest() {
		...
		interact.executeWithDelay(() -> cat.clickChargeActivityType_PL());
	}

	@Test(priority = 1, retryAnalyzer = RetryAnalyzer.class)
	public void Search_using_charge_code_PL_TC_037() {
		initialTest();
		Interactions interact = new Interactions(driver);
		ChargeActivityTypePage cat = new ChargeActivityTypePage(driver);
	...
	public void Search_and_refresh_using_charge_code_PL_TC_038() {
		initialTest();
		Interactions interact = new Interactions(driver);
		ChargeActivityTypePage cat = new ChargeActivityTypePage(driver);
		interact.executeWithDelay(() -> cat.search_using_charge_code());
	...
	public void Search_using_project_Name_PL_TC_039() {
		initialTest();
		Interactions interact = new Interactions(driver);
		ChargeActivityTypePage cat = new ChargeActivityTypePage(driver);
	...
	public void Search_operation_PL_TC_040() {
		initialTest();
		Interactions interact = new Interactions(driver);
		ChargeActivityTypePage cat = new ChargeActivityTypePage(driver);
	...
	public void add_chargeActivityType_PL_TC_034() {
		initialTest();
		Interactions interact = new Interactions(driver);
		ChargeActivityTypePage cat = new ChargeActivityTypePage(driver);
	...
	public void modify_chargeActivityType_PL_TC_035() {
		initialTest();
		Interactions interact = new Interactions(driver);
		ChargeActivityTypePage cat = new ChargeActivityTypePage(driver);
	...
	public void delete_chargeActivityType_PL_TC_036() {
		initialTest();
		Interactions interact = new Interactions(driver);
		ChargeActivityTypePage cat = new ChargeActivityTypePage(driver);
		interact.executeWithDelay(() -> cat.clickChargeCode());

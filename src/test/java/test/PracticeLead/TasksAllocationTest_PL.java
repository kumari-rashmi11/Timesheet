...
public class TasksAllocationTest_PL extends BaseTest {
	public void initialTestFor_PL() {
		...
		interact.executeWithDelay(() -> tasks.clickTasksAllocationTab_PL());
		Assert.assertEquals(tasks.isTasksAllocationPage(), "Tasks");
	}

	@Test(priority = 2, retryAnalyzer = RetryAnalyzer.class)
	public void Remaining_hours_alert_icon_TC_295_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.alertIconHover_PL());
	}

	@Test(priority = 3, retryAnalyzer = RetryAnalyzer.class)
	public void Create_New_Task_TC_041_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
	...
	public void Edit_Task_TC_042_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickSelectTask_PL());
	...
	public void Delete_Task_TC_043_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickSelectTask_PL());
...
//		interact.executeWithDelay(() -> tasks.clickDeleteConfirm());
	...
	public void Search_Operation_TC_044_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
	...
	public void Search_and_Reset_Operation_TC_045_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.searchEmployee());
	...
	public void Only_Active_Employee_Visibility_for_Reallocation_Task_TC_282_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_PL());
		interact.executeWithDelay(() -> tasks.clickAssignBtn());
		interact.executeWithDelay(() -> tasks.clickAssignEmployeeDiv());
	}

	@Test(priority = 9, retryAnalyzer = RetryAnalyzer.class)
	public void Task_Reallocation_Operation_TC_132_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_PL());
...
//		interact.executeWithDelay(()-> tasks.clickReallocateTask());
	...
	public void Modification_of_Reallocated_Task_TC_133_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_PL());
...
//		interact.executeWithDelay(()-> tasks.clickReallocateTask());
	...
	public void Delete_operation_of_reallocation_task_TC_134_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_PL());
	...
	public void Cannot_Allocate_hours_above_consumed_TC_164_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_PL());
	...
	public void Only_Active_Employee_Visibility_for_Task_Allocation_TC_278_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickCreateTaskBtn());
	...
	public void Saving_Reallocated_Task_after_Edit_TC_135_PL() {
		TasksAllocationPage tasks = new TasksAllocationPage(driver);
		Interactions interact = new Interactions(driver);
		initialTestFor_PL();
		interact.executeWithDelay(() -> tasks.clickreallocBtn_PL());
